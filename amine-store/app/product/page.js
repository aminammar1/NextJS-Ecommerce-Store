      ...
      <div className="container  py-10 mx-auto">
        <div className="grid grid-cols-4 items-center gap-14">
          <div className="Product_col">
            <div className="bg-gray-300 mb-4 p-5">
              <Image
                src="/assets/stawberry5.png"
                width={1000}
                height={50}
                alt="category"
            ...
            <div className="grid grid-cols-2 items-center py-2">
              <h3> Product </h3>
              <h1 className="text-end font-semibold text-lg"> 30$ </h1>
            </div>{" "}
            {""}
            <div className="grid grid-cols-2 items-center py-2 px-0">
              <Button className="bg-green-500 text-white hover:bg-green-900 ">
                Add to cart <ShoppingBag size={36} />
              </Button>
